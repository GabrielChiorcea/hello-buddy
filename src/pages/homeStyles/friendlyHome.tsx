      ...
      <section className="py-12 md:py-16">
        <div className="container mx-auto px-4">
          <div className="flex items-center gap-2 sm:gap-3 mb-8 min-w-0 w-full">
            <motion.h2 className="text-2xl md:text-3xl font-bold text-foreground shrink-0" initial="hidden" whileInView="visible" viewport={{ once: true }} custom={0} variants={fadeUp}>
