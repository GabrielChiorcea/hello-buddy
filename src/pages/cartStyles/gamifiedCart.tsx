      ...
      <Layout>
        <div className="container mx-auto px-4 py-16">
          <div className="max-w-md mx-auto text-center">
            ...
            <h1 className="text-2xl font-extrabold mb-2 text-foreground">{texts.cart.empty}</h1>
          ...
          <div>
            <Card className="sticky top-24 border-primary/20 shadow-xl bg-gradient-to-b from-primary/5 to-background">
              ...
              <CardContent className="space-y-4">
                <div className="flex justify-between"><span className="text-muted-foreground">{texts.cart.subtotal}</span><span className="font-bold">{subtotal} {texts.common.currency}</span></div>
                <div className="flex justify-between">
                  <span className="text-muted-foreground">{texts.cart.delivery}</span>
                  <span className="font-bold">{deliveryFee === 0 ? <span className="text-success">{texts.cart.freeDelivery}</span> : `${deliveryFee} ${texts.common.currency}`}</span>
                </div>
                {deliveryFee > 0 && <p className="text-xs text-muted-foreground">Livrare gratuită peste {FREE_DELIVERY_THRESHOLD} {texts.common.currency}</p>}
                <Separator />
