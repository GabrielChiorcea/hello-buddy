...
const BonusBanner = ({ desktop = false, visibility }: BonusBannerProps) => {
  ...
  return (
    <div
      className={`items-center gap-3.5 rounded-xl border border-orange-300 bg-orange-50 px-3 py-3 ${
    ...
    >
      ...
      <div className="min-w-0 flex-1">
        ...
        {/* Progress bar */}
        <div className="h-1.5 overflow-hidden rounded-full bg-orange-200">
        ...
        <div className="mt-1 flex justify-between">
          ...
          <span className="text-[11px] font-bold text-orange-600">
            {texts.home.heroGuestFomoReward}
          </span>
        </div>
      </div>
