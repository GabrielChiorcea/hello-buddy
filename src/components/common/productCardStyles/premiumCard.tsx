    ...
    >
      ...
      >
        ...
        {activeCouponDiscount > 0 && (
          <span className="absolute right-3 top-3 z-10 hidden h-10 min-w-10 items-center justify-center rounded-full bg-primary text-primary-foreground text-xs font-semibold px-2 shadow-md md:inline-flex">
      ...
      <div className={cn('flex flex-1 min-w-0 flex-col justify-between gap-1', 'md:px-5 md:pt-4 md:pb-5 md:flex-1')}>
        ...
        {compactSubtitle ? (
          <p className="text-xs md:text-[13px] text-muted-foreground/70 line-clamp-2 break-words min-w-0 mt-1 font-light leading-relaxed">
